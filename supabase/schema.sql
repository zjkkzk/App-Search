...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:6Mag8v8SnGHMXjR+HJRs3Q==$82UiYDkvVyesi4QUVbE2KlOPnaVtuYJVxw3Ni5sz1GY=:WwjoDkE4FIF8TLDjQwLF76gE4lTYXZ5cE46U7sKh7+w=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:J7e9Da+sZKXe9jsMF0KC7Q==$LlcutnkjHBvfTQ9ajwJ/nxP8PJhcdf2QfoY4i+qrgHI=:UISM2nKpNF6ldR7iUfJTGmajOag89lchQ8ZNNCo2l38=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:K++av9dga3ouMX2x5WGOoQ==$bJjLk+p+bp4Wtih5WjBlixTaOt27aDRiVwYoevzeVcE=:Onh6mBhqb9tRvudOlEM3+cAaSqyUfBMpqb2zT/kQ3OA=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:n7OOFw5xOc8LuZiopTbHcA==$bS/k7qmYc/vjghW7peV7Ynvv0iODT9IYEONm/vSdRE0=:KmD70rEIJ0uQkFpoEORSM54DWEiZtBLty9F41ICek5k=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:wDQMzKNXdCIiVYRzRwursw==$YQ11jNtfijlGMgLHmaGTdOpxl7n4933/iwvIuzUGwm8=:IgdYSgoUc6x7mrP5LX4tS0WjVRvT6fkYhJu9rEvYhJI=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:c049k6mCdxl0K2PlmHcfDw==$o/GHfYFCgjut35w9rFSuARgXiT05VObXvbjl8P6+hW8=:YYSSP/SWb1I0sef7vFw627peiF4bYezBgosAZtwXLAA=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:6RdcHStDOud2AVDLYZlrWg==$rjGOg91R3qRNHIOi5SzE/W5i3h77DCDVa4wlN5zSDQE=:Jii1g7RIdUvXmTd/r88SNQVrBUk2uVc2+4rBfmjeQOE=';
...
--
-- Name: apps_cache; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."apps_cache" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "owner" "text" NOT NULL,
    "repo" "text" NOT NULL,
...
--
-- Name: releases_cache; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: apps_cache apps_cache_full_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."apps_cache"
    ADD CONSTRAINT "apps_cache_full_name_key" UNIQUE ("full_name");


--
-- Name: apps_cache apps_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."apps_cache"
    ADD CONSTRAINT "apps_cache_pkey" PRIMARY KEY ("id");


--
-- Name: releases_cache releases_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."releases_cache"
    ADD CONSTRAINT "releases_cache_pkey" PRIMARY KEY ("id");
...
--
-- Name: idx_apps_cache_language; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_apps_cache_language" ON "public"."apps_cache" USING "btree" ("language");


--
-- Name: idx_apps_cache_platforms; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_apps_cache_platforms" ON "public"."apps_cache" USING "btree" ("platforms");


--
-- Name: idx_apps_cache_stars; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_apps_cache_stars" ON "public"."apps_cache" USING "btree" ("stars" DESC);


--
-- Name: idx_apps_cache_updated; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_apps_cache_updated" ON "public"."apps_cache" USING "btree" ("updated_at" DESC);


--
-- Name: idx_releases_cache_app; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_releases_cache_app" ON "public"."releases_cache" USING "btree" ("app_id");
...
--
-- Name: releases_cache releases_cache_app_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."releases_cache"
    ADD CONSTRAINT "releases_cache_app_id_fkey" FOREIGN KEY ("app_id") REFERENCES "public"."apps_cache"("id") ON DELETE CASCADE;
...
--
-- Name: apps_cache Allow anonymous read apps; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anonymous read apps" ON "public"."apps_cache" FOR SELECT TO "anon" USING (true);


--
-- Name: releases_cache Allow anonymous read releases; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow anonymous read releases" ON "public"."releases_cache" FOR SELECT TO "anon" USING (true);


--
-- Name: apps_cache; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."apps_cache" ENABLE ROW LEVEL SECURITY;

--
-- Name: releases_cache; Type: ROW SECURITY; Schema: public; Owner: -
--
